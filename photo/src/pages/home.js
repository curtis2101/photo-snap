    ...
    return ( 
        <main className='flex flex-col h-screen w-full overflow-x-hidden overflow-scroll'>
            ...
            <div className='grid grid-cols-8 auto-rows-min'>
                <div style={{backgroundImage: `url(${Pic})`}} className='w-full h-72 md:min-h-full bg-no-repeat bg-cover bg-center col-start-1 col-end-9 md:col-start-6 md:col-end-9 lg:col-start-4 row-start-1 row-end-2'></div>
                ...
                <div style={{backgroundImage: `url(${Laptop})`}} className='w-full h-72 md:min-h-full bg-no-repeat bg-cover bg-center col-start-1 col-end-9 md:col-end-4 lg:col-end-6'></div>
                ...
                <div style={{backgroundImage: `url(${Mountains})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 md:col-end-5 lg:col-end-3 md:min-h-full h-96'>
                ...
                <div style={{backgroundImage: `url(${City})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-9 md:col-start-5 lg:col-start-3 lg:col-end-5 md:h-full h-96'>
                ...
                <div style={{backgroundImage: `url(${Voyage})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-9 md:col-end-5 lg:col-start-5 lg:col-end-7 md:h-full h-96'>
                ...
                <div style={{backgroundImage: `url(${Architec})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-9 md:col-start-5 lg:col-start-7 md:h-full h-96'>
