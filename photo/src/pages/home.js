    ...
    return ( 
        <main className='flex flex-col h-screen w-full overflow-x-hidden overflow-scroll'>
            ...
            <div className='grid grid-cols-6 auto-rows-min'>
                <div style={{backgroundImage: `url(${Pic})`}} className='w-full h-72 md:h-full bg-no-repeat bg-cover bg-center col-start-1 col-end-7 md:col-start-5 md:col-end-7 row-start-1 row-end-2'></div>
                <section className='bg-black flex flex-col pl-8 pt-16 md:pl-16 col-start-1 col-end-7 md:col-end-5'>
                    <h1 className='text-white text-3xl items-start font-bold pb-4 md:text-4xl md:w-7/12 md:pt-44 w-9/12'>CREATE AND SHARE YOUR PHOTO STORIES.</h1>
                ...
                <div style={{backgroundImage: `url(${Laptop})`}} className='w-full h-72 md:h-full bg-no-repeat bg-cover bg-center col-start-1 col-end-7 md:col-end-3'></div>
                <section className='bg-white flex flex-col pl-8 md:pl-16 pt-16 col-start-1 col-end-6 md:col-start-3'>
                    <h1 className='text-black text-3xl items-start font-bold pb-4 w-8/12 md:pt-32 md:text-4xl md:w-4/6'>BEAUTIFUL STORIES EVERY TIME</h1>
                ...
                <div style={{backgroundImage: `url(${Man})`}} className='h-96 md:h-full bg-no-repeat bg-cover bg-center col-start-1 col-end-7 md:col-start-5 md:row-start-3'></div>
                <section className='bg-white flex flex-col pl-8 md:pl-16 pt-16 col-start-1 col-end-7 md:col-end-5'>
                    <h1 className='text-black text-3xl items-start font-bold md:text-4xl pb-4 w-8/12 md:pt-40'>DESIGNED FOR EVERYONE</h1>
                    <p className='text-black text-base font-normal opacity-60 pb-6 md:w-4/6 '>Photosnap can help you create stories that resonate with your audience.  Our tool is designed for photographers of all levels, brands, businesses you name it. </p>
                ...
                <div style={{backgroundImage: `url(${Mountains})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-7 md:col-end-4 md:h-full h-96'>
                ...
                <div style={{backgroundImage: `url(${City})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-7 md:col-start-4 md:h-full h-96'>
                ...
                <div style={{backgroundImage: `url(${Voyage})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-7 md:col-end-4 md:h-full h-96'>
                ...
                <div style={{backgroundImage: `url(${Architec})`}} className='bg-no-repeat bg-cover flex flex-col justify-end col-start-1 col-end-7 md:col-start-4 md:h-full h-96'>
