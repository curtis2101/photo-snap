    ...
    return ( 
        <main className='flex flex-col h-screen w-full overflow-x-hidden overflow-scroll'>
            ...
            <div className='grid grid-cols-8 auto-rows-min'>
                ...
                <div style={{backgroundImage: `url(${Moon2})`}} className='hidden md:flex pl-10 pt-32 pb-32 bg-no-repeat bg-cover bg-top flex-col justify-end col-start-1 col-end-9'>
                    <p className='text-white text-xs font-bold pb-4'>LAST MONTH'S FEATURED STORY</p>
                ...
                <div style={{backgroundImage: `url(${Sunset})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                ...
                <div style={{backgroundImage: `url(${Voyage})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="April 16th 2020"
                ...
                <div style={{backgroundImage: `url(${Architecturals})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="April 9th 2020"
                ...
                <div style={{backgroundImage: `url(${World})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="April 7th 2020"
                ...
                <div style={{backgroundImage: `url(${Corners})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="April 3rd 2020"
                ...
                <div style={{backgroundImage: `url(${Africa})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card  
                ...
                <div style={{backgroundImage: `url(${Trip})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                ...
                <div style={{backgroundImage: `url(${Rage})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                ...
                <div style={{backgroundImage: `url(${Running})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                ...
                <div style={{backgroundImage: `url(${Waves})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                ...
                <div style={{backgroundImage: `url(${Waters})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="March 9th 2020"
                    title="Calm Waters"
                    author="by Samantha Brooke"
                ...
                <div style={{backgroundImage: `url(${MilkyWay})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="March 5th 2020"
                    title="The Milky Way"
                    author="by Benjamin Cruz"
                ...
                <div style={{backgroundImage: `url(${Forest})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="March 4th 2020"
                ...
                <div style={{backgroundImage: `url(${Somwarpet})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
                    date="March 1st 2020"
                ...
                <div style={{backgroundImage: `url(${Dreams})`}} className='bg-no-repeat bg-cover bg-center flex flex-col justify-end col-start-1 col-end-9 h-96'>
                <Card   
