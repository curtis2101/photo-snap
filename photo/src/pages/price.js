    ...
    return (
        <main className='flex flex-col h-screen w-full overflow-x-hidden overflow-scroll'>
            ...
            <div className='grid grid-cols-8 auto-rows-min'>
                ...
                <img src={Woman2} alt='woman with camera' className='hidden md:block col-start-6 col-end-9 w-full h-full'/>
                <div className='col-start-1 col-end-9 md:row-start-1 lg:col-end-4 md:col-end-6 pl-7 pr-7 md:pl-14 md:pr-14 md:pt-6 lg:pl-20 lg:pr-20 bg-black text-white '>
                    <h1 className='text-3xl md:text-4xl font-bold pt-16 md:mt-44 md:pt-0 lg:pt-20'>PRICING</h1>
                    <p className='font-normal text-base md:text-lg opacity-60 pt-4 md:pt-5 lg:pt-7 lg:w-full pb-16 md:pb-0'>Create a your stories, Photosnap is a platform for photographers and visual storytellers. It’s the simple way to create and share your photos.</p>
                </div>
