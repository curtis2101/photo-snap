    ...
    return (
        <main className='flex flex-col h-screen w-full overflow-x-hidden overflow-scroll'>
            ...
            <div className='grid grid-cols-8 auto-rows-min'>
                ...
                {toggle? <section className='flex items-center gap-8 pt-16 pb-10 lg:pt-40 justify-center'>
                    ...
                    <section className='flex items-center gap-8 pt-16 lg:pt-40 pb-10 justify-center'>
